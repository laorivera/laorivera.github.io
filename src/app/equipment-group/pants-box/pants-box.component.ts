...
export class PantsBoxComponent {
  //store values
  ...
  set classSelection(value: number) {
    ...
    this.resetSelection();
    this.fetchList_Character(this.apiConfig.getApiUrl(`/pantslist/${this._classSelection}`));
  ...
  fetchList_Character(url: string) {
    this.http.get<{ list: ListItem[] }>(url).subscribe({
      ...
      error: (err) => {
        console.error('Error fetching pants list:', err);
      },
  ...
  onChangeRarity(event: number) {
    ...
    if (this.selectedItem?.name) {
      this.fetchList_Rating(this.apiConfig.getApiUrl(`/pantsratinglist/?itempants=${this.selectedItem.name}&rarityselect_pants=${this.selectedRarity}`));
      this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem.name}`));
    }
  ...
  onChangeEnchantment_TypeUncommon(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem?.name}&enchantment_pantstype=${currentEnchantmentUncommon}&enchantment_pantstype2=${currentEnchantmentRare}&enchantment_pantstype3=${currentEnchantmentEpic}&enchantment_pantstype4=${currentEnchantmentLegendary}&enchantment_pantstype5=${currentEnchantmentUnique}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${currentEnchantmentUncommon}`));
  ...
  onChangeEnchantment_ValueUncommon(event: number){
    ...
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${this.selectedEnchantments['uncommon'].type}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeRare(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem?.name}&enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${this.selectedEnchantments['rare'].type}`));
  ...
  onChangeEnchantment_ValueRare(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${this.selectedEnchantments['uncommon'].type}&enchantment_pantstype2=${this.selectedEnchantments['rare'].type}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeEpic(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem?.name}&enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}`));
  ...
  onChangeEnchantment_ValueEpic(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${this.selectedEnchantments['uncommon'].type}&enchantment_pantstype2=${this.selectedEnchantments['rare'].type}&enchantment_pantstype3=${this.selectedEnchantments['epic'].type}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeLegendary(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem?.name}&enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${this.selectedEnchantments['legendary'].type}`));
  ...
  onChangeEnchantment_ValueLegendary(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${this.selectedEnchantments['uncommon'].type}&enchantment_pantstype2=${this.selectedEnchantments['rare'].type}&enchantment_pantstype3=${this.selectedEnchantments['epic'].type}&enchantment_pantstype4=${this.selectedEnchantments['legendary'].type}&enchantment_pantstype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeUnique(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpants/?itempants=${this.selectedItem?.name}&enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpants/?enchantment_pantstype=${currentUncommonType}&enchantment_pantstype2=${currentRareType}&enchantment_pantstype3=${currentEpicType}&enchantment_pantstype4=${currentLegendaryType}&enchantment_pantstype5=${this.selectedEnchantments['unique'].type}`));
  ...
  //array rarity 
  rarityPants: string[] = ["No selection", "Poor", "Common", "Uncommon", "Rare", "Epic", "Legendary", "Unique"];
