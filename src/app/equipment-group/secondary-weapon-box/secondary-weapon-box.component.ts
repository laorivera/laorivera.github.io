...
export class SecondaryWeaponBoxComponent {
  ...
  set classSelection(value: number) {
    ...
    this.resetSelection();
    this.fetchList_Items(this.apiConfig.getApiUrl(`/pwtlist/${this._classSelection}`));
  ...
  onChangeRarity(event: number) {
    ...
    if (this.selectedItem?.name) {
      this.fetchList_Rating(this.apiConfig.getApiUrl(`/pwtratinglist/?itempwt=${this.selectedItem.name}&rarityselect_pwt=${this.selectedRarity}`));
      this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem.name}`));
    }
  ...
  onChangeEnchantment_TypeUncommon(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem?.name}&enchantment_pwttype=${currentEnchantmentUncommon}&enchantment_pwttype2=${currentEnchantmentRare}&enchantment_pwttype3=${currentEnchantmentEpic}&enchantment_pwttype4=${currentEnchantmentLegendary}&enchantment_pwttype5=${currentEnchantmentUnique}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${currentEnchantmentUncommon}`));
  ...
  onChangeEnchantment_ValueUncommon(event: number){
    ...
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${this.selectedEnchantments['uncommon'].type}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeRare(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem?.name}&enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype2=${this.selectedEnchantments['rare'].type}`));
  ...
  onChangeEnchantment_ValueRare(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${this.selectedEnchantments['uncommon'].type}&enchantment_pwttype2=${this.selectedEnchantments['rare'].type}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeEpic(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem?.name}&enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}`));
  ...
  onChangeEnchantment_ValueEpic(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${this.selectedEnchantments['uncommon'].type}&enchantment_pwttype2=${this.selectedEnchantments['rare'].type}&enchantment_pwttype3=${this.selectedEnchantments['epic'].type}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeLegendary(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem?.name}&enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${this.selectedEnchantments['legendary'].type}`));
  ...
  onChangeEnchantment_ValueLegendary(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${this.selectedEnchantments['uncommon'].type}&enchantment_pwttype2=${this.selectedEnchantments['rare'].type}&enchantment_pwttype3=${this.selectedEnchantments['epic'].type}&enchantment_pwttype4=${this.selectedEnchantments['legendary'].type}&enchantment_pwttype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeUnique(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?itempwt=${this.selectedItem?.name}&enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${currentUncommonType}&enchantment_pwttype2=${currentRareType}&enchantment_pwttype3=${currentEpicType}&enchantment_pwttype4=${currentLegendaryType}&enchantment_pwttype5=${this.selectedEnchantments['unique'].type}`));
  ...
  onChangeEnchantment_ValueUnique(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistpwt/?enchantment_pwttype=${this.selectedEnchantments['uncommon'].type}&enchantment_pwttype2=${this.selectedEnchantments['rare'].type}&enchantment_pwttype3=${this.selectedEnchantments['epic'].type}&enchantment_pwttype4=${this.selectedEnchantments['legendary'].type}&enchantment_pwttype5=${this.selectedEnchantments['unique'].type}`));
