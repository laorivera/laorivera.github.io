...
export class RingBoxComponentTwo {
  ...
  onChangeEnchantment_TypeUncommon(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?itemringtwo=${this.selectedItem?.name}&enchantment_ringtwotype=${currentEnchantmentUncommon}&enchantment_ringtwotype2=${currentEnchantmentRare}&enchantment_ringtwotype3=${currentEnchantmentEpic}&enchantment_ringtwotype4=${currentEnchantmentLegendary}&enchantment_ringtwotype5=${currentEnchantmentUnique}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${currentEnchantmentUncommon}`));
  ...
  onChangeEnchantment_ValueUncommon(event: number){
    ...
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${this.selectedEnchantments['uncommon'].type}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeRare(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?itemringtwo=${this.selectedItem?.name}&enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype2=${this.selectedEnchantments['rare'].type}`));
  ...
  onChangeEnchantment_ValueRare(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${this.selectedEnchantments['uncommon'].type}&enchantment_ringtwotype2=${this.selectedEnchantments['rare'].type}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeEpic(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?itemringtwo=${this.selectedItem?.name}&enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}`));
  ...
  onChangeEnchantment_ValueEpic(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${this.selectedEnchantments['uncommon'].type}&enchantment_ringtwotype2=${this.selectedEnchantments['rare'].type}&enchantment_ringtwotype3=${this.selectedEnchantments['epic'].type}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeLegendary(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?itemringtwo=${this.selectedItem?.name}&enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${this.selectedEnchantments['legendary'].type}`));
  ...
  onChangeEnchantment_ValueLegendary(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${this.selectedEnchantments['uncommon'].type}&enchantment_ringtwotype2=${this.selectedEnchantments['rare'].type}&enchantment_ringtwotype3=${this.selectedEnchantments['epic'].type}&enchantment_ringtwotype4=${this.selectedEnchantments['legendary'].type}&enchantment_ringtwotype5=${currentUniqueType}`));
  ...
  onChangeEnchantment_TypeUnique(event: string){
    ...
    this.fetchEnchantment_List(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?itemringtwo=${this.selectedItem?.name}&enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${currentUniqueType}`));
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${currentUncommonType}&enchantment_ringtwotype2=${currentRareType}&enchantment_ringtwotype3=${currentEpicType}&enchantment_ringtwotype4=${currentLegendaryType}&enchantment_ringtwotype5=${this.selectedEnchantments['unique'].type}`));
  ...
  onChangeEnchantment_ValueUnique(event: number){
    ...
    // Re-fetch enchantment values with all current enchantment types
    this.fetchEnchantment_Value(this.apiConfig.getApiUrl(`/enchantmentlistringtwo/?enchantment_ringtwotype=${this.selectedEnchantments['uncommon'].type}&enchantment_ringtwotype2=${this.selectedEnchantments['rare'].type}&enchantment_ringtwotype3=${this.selectedEnchantments['epic'].type}&enchantment_ringtwotype4=${this.selectedEnchantments['legendary'].type}&enchantment_ringtwotype5=${this.selectedEnchantments['unique'].type}`));
